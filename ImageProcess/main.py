...
def main(testdir=None, need_preprocess=False, need_decode=False, need_phase=False, need_track=False, need_compress=False):
    ...
    try:
        do_process(testdir=testdir, need_preprocess=need_preprocess, need_decode=need_decode, need_phase=need_phase, need_track=need_track, need_compress=need_compress)
    except Exception, e:
...
def do_process(testdir=None, need_preprocess=False, need_decode=False, need_phase=False, need_track=False, need_compress=False):
    ...
    output_file_phase=os.path.join(testdir,r'result_phase.txt')
    ...
    if need_preprocess:
        ...
        preProcessing.rename_rotate_crop_Dir(working_dir, cfg)
    ...
    if need_phase:
        ...
        detectPhase.detectPhaseInDir(calibrate_dir, working_dir, cfg, output_file_phase)
